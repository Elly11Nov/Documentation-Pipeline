...
Classification makes the information easier to structure and reuse.
...
The full extracted information is captured in ../examples/extracted-api-information.md.
...
For this project, the extracted API information is captured in ../examples/extracted-api-information.md.

This information is then used to develop the API reference and tutorial described in api-documentation-workflow.md.
